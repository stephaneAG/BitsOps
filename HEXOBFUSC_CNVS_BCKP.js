...
var encodeTextInputBtn = document.createElement('button');
encodeTextInputBtn.id = 'encode-text-input';
encodeTextInputBtn.textContent = 'encode';
encodeTextInputBtn.addEventListener('click', function(e){
  sentenceToImg( textInput.value ); // encode text as img & popup save dialog
}, false);
document.body.append(encodeTextInputBtn);
...
function readSingleFile(e) {
  ...
  reader.onload = function(e) {
    ...
    img.onload = function(e){
      ...
      textInput.value = imageToSentence(img);
    }
